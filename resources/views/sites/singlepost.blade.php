            ...
            <div class="col-lg-9 blog-post-single">
                <div class="blog-item">
                    ...
                    <div class="post-content">
                        ...
                        <div class="meta-info-blog">
                            {{-- <span><i class="fa fa-calendar"></i> <a href="#">{{$post->created_at->format('d M Y')}}</a> </span> --}}
                ...
                <div class="blog-author">
                    <div class="author-bio">
                        <h3 class="author_name"><a href="#">{{$post->user->name}}</a></h3>
                        <h5>{{$post->user->role}} <a href="#">SMK Pekalongan</a></h5>
                        <p class="author_det">
