	...
	<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				<div id="home" class="first-section" style="background-image:url('{{config('sekolah.banner')}}">
					<div class="dtab">
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									<div class="big-tagline">
										<h2><strong>Selamat Datang </strong><br>di SMK Pekalongan</h2>
										<p class="lead">Sekolah favorit no.1 di Pekalongan </p>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    ...
                    <p class="lead">Artikel terbaru SMK Pekalogan</p>
                </div>
            </div><!-- end title -->
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="message-box">
                            <h4>{{$post->created_at->diffforHumans()}} | oleh {{$post->user->name}}</h4>
                            <h2>{{$post->title}}</h2>

                            {!! $post->content !!}

                            <a href="{{route('site.single.post', $post->slug)}}" class="hover-btn-new orange"><span>Detail</span></a>
                        </div><!-- end messagebox -->
                    </div><!-- end col -->
                    
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="post-media wow fadeIn">
                            <img src="{{$post->thumbnail()}}" alt="" class="img-fluid img-rounded">
                        </div><!-- end media -->
                    </div><!-- end col -->
                </div>
            @else
